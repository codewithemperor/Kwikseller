    ...
    <React.Suspense
      fallback={
        <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 px-4 py-12 dark:from-gray-950 dark:to-gray-900">
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-gray-200 bg-white/90 px-8 py-7 text-center shadow-sm dark:border-white/10 dark:bg-white/5">
