...
export default function AuthLayout({
  ...
  return (
    <GuestRoute>
      <div className="relative min-h-screen overflow-x-hidden bg-linear-to-br from-background via-background to-sky-100/40 dark:from-background dark:via-background dark:to-sky-950/30">
