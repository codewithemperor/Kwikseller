...
export default function AuthLayout({
  ...
  return (
    <GuestRoute>
      <div className="relative h-screen overflow-hidden bg-linear-to-br from-background via-background to-sky-100/40 dark:from-background dark:via-background dark:to-sky-950/30">
        ...
        <div className="relative mx-auto flex h-full w-full max-w-7xl flex-col px-4 py-4 sm:px-6 sm:py-6">
