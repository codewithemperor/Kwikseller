          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              {isAuthLoading ? null : isAuthenticated && user ? (
                ...
                <>
                  <Button variant="ghost" size="sm" onPress={() => router.push('/login')}>Sign In</Button>
                  <Button variant="primary" size="sm" onPress={() => router.push('/register')}>Get Started</Button>
                </>
              )}
            </div>
          </div>
      ...
      <footer className="border-t border-divider py-12 mt-auto">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center text-sm text-default-500">
            <p>&copy; {new Date().getFullYear()} KWIKSELLER. All rights reserved. Africa&apos;s Commerce Platform.</p>
          </div>
        </div>
      </footer>
    </div>
