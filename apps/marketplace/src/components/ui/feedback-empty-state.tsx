...
/**
 * FeedbackEmptyState - The @kwikseller/ui version of EmptyState
 * (Kept separate from the marketplace's enhanced empty-state.tsx which has different props)
 */
...
// Also re-export as EmptyState for backward compatibility with @kwikseller/ui imports
export { FeedbackEmptyState as EmptyState }
