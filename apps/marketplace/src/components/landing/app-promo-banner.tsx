...
const features: Feature[] = [
  {
    ...
    description: 'Browse and buy from thousands of African vendors anywhere, anytime.',
  },
  {
    icon: MapPin,
    title: 'Real-time tracking',
    description: 'Track your deliveries live with real-time updates and notifications.',
  },
  {
    icon: Tag,
    title: 'Exclusive app deals',
    description: 'Get access to special discounts and flash sales only on the app.',
  },
]
          ...
          <div className="px-3 pt-2 space-y-3">
            ...
            <div className="h-20 rounded-xl kwik-gradient flex items-center justify-center overflow-hidden">
              <div className="relative text-center">
                <p className="text-white/60 text-[9px] font-medium uppercase tracking-wider">KWIKSELLER</p>
                <p className="text-white text-xs font-bold mt-0.5">Shop Smarter</p>
                ...
                <div className="mt-2 inline-flex items-center gap-1 bg-white/20 rounded-full px-2 py-0.5">
                  <span className="text-white text-[8px] font-medium">Shop Now</span>
