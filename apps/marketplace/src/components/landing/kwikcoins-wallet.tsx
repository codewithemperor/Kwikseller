...
export function KwikCoinsWallet() {
  ...
  const isActionsInView = useInView(actionsRef, {
    once: true,
    margin: "-40px",
  });
  const isTransactionsInView = useInView(transactionsRef, {
    once: true,
    margin: "-40px",
  });
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-background relative">
      ...
      <div className="container mx-auto px-0 md:px-4  max-w-5xl relative z-10">
        {/* ─── Section Header ─── */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Track Your <span className="kwik-gradient-text">Rewards</span>
          </h2>
          <p className="text-default-500 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Manage your KwikCoins balance, view transactions, and redeem your
            rewards — all from one convenient dashboard.
          </p>
        </motion.div>
            ...
            >
              {quickActions.map((action, i) => {
                ...
                return (
                  ...
                  >
                    <Card className="p-4 border-none shadow-sm hover:shadow-lg transition-all duration-300 bg-background h-full cursor-pointer">
                  ...
                  {transactions.map((tx, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        initial="hidden"
                        animate={isTransactionsInView ? "visible" : "hidden"}
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-default-400 text-xs">{tx.date}</p>
                        </div>
