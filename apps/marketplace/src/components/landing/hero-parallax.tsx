...
function StaticHero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-0 md:px-4  text-center">
        <Chip
          variant="soft"
          className="mb-6 bg-accent/10 text-accent-foreground"
        >
...
export function HeroParallax() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Gradient orb – accent */}
        <div className="absolute -top-20 -left-20 w-[380px] h-[380px] rounded-full bg-accent/20 blur-[120px]" />
        {/* Gradient orb – warning */}
        <div className="absolute -bottom-20 -right-20 w-[350px] h-[350px] rounded-full bg-warning/20 blur-[120px]" />
      ...
      >
        ...
        <div className="relative w-full h-full hidden md:block">
          {productBubbles.map((bubble) => (
            <ProductBubble key={bubble.id} bubble={bubble} scrollY={scrollY} />
          ))}
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="relative z-10 container mx-auto px-0 md:px-4  text-center"
      >
        <motion.div
