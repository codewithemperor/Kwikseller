...
const steps: OnboardingStep[] = [
  {
    ...
    decorElements: [
      { shape: 'circle', position: '-top-4 -right-4', size: 'w-20 h-20', color: 'bg-blue-400/20' },
      { shape: 'circle', position: '-bottom-3 -left-3', size: 'w-14 h-14', color: 'bg-cyan-400/20' },
      { shape: 'rounded-xl', position: 'top-1/2 right-6', size: 'w-10 h-10 rotate-12', color: 'bg-blue-500/10' },
      { shape: 'circle', position: 'top-8 left-4', size: 'w-6 h-6', color: 'bg-cyan-300/30' },
    ],
  },
  {
    number: 2,
  ...
  },
  {
    ...
    decorElements: [
      ...
      { shape: 'circle', position: '-bottom-3 -left-3', size: 'w-14 h-14', color: 'bg-green-400/20' },
      { shape: 'rounded-xl', position: 'top-1/2 right-6', size: 'w-10 h-10 rotate-12', color: 'bg-emerald-500/10' },
      { shape: 'circle', position: 'top-8 left-4', size: 'w-6 h-6', color: 'bg-green-300/30' },
    ],
  },
  {
    number: 4,
...
function StepImagePlaceholder({
  ...
  return (
    ...
    >
      {/* Gradient background */}
      <div
        className={`absolute inset-0 bg-gradient-to-br ${step.gradientFrom} ${step.gradientTo} opacity-90`}
      />
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-5">
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.gradientFrom} ${step.gradientTo} flex items-center justify-center text-white font-bold text-lg shadow-md`}
              >
                {step.number}
              </div>
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.gradientFrom} ${step.gradientTo} flex items-center justify-center shadow-md`}
              >
                ...
                <div
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ${
                    s.number <= step.number
                      ? `bg-gradient-to-r ${s.gradientFrom} ${s.gradientTo} w-8`
                      : 'bg-default-200 w-4'
                  }`}
                />
              ))}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-default-500 mb-8 max-w-md mx-auto">
              Create your free store today and reach millions of buyers across Africa.
            </p>
            <Button
              size="lg"
