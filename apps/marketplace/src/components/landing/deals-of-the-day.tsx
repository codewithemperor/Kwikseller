...
const deals = [
  {
    id: "d1",
    name: "Ankara Print Bundle (5 yards)",
    originalPrice: 18000,
    dealPrice: 8999,
    initials: "AP",
      ...
      <div className="container mx-auto px-0 md:px-4  relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            <span className="text-2xl md:text-3xl font-bold text-white/40 mb-6 mt-0">
              :
            </span>
        ...
        <div className="relative">
          ...
          {/* Fade edges */}
          <div className="absolute top-0 left-0 w-8 h-full bg-foreground/80 to-transparent pointer-events-none z-10 hidden md:block" />
          <div className="absolute top-0 right-0 w-8 h-full bg-foreground/80 to-transparent pointer-events-none z-10 hidden md:block" />
        </div>
      </div>
    </section>
  );
