...
const milestones: MilestoneItem[] = [
  ...
  },
  {
    ...
    description:
      'Introduced our rewards program to incentivize vendor growth',
    icon: Coins,
  ...
  },
  {
    ...
    title: '2M+ Orders',
    description:
      'Over 2 million orders delivered with 99.9% satisfaction rate',
    icon: TrendingUp,
    stat: '2M+ Delivered',
    isLatest: true,
  },
    ...
    <div ref={lineRef} className={className}>
      <div className="relative w-full h-full">
        ...
        <motion.div
          ...
          className="absolute top-0 left-0 w-full bg-gradient-to-b from-white/40 via-white/20 to-transparent"
        />
      </div>
    </div>
  )
