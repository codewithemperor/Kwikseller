        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-default-500 max-w-2xl mx-auto">
              Join thousands of successful vendors who are building thriving businesses across Africa
              with KWIKSELLER.
            </p>
          </div>
        </motion.div>
                ...
                {testimonials.slice(current, current + 3).map((testimonial, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mt-auto">
                      <div
                        className={`w-11 h-11 rounded-full bg-gradient-to-br ${testimonial.accentColor} flex items-center justify-center text-white font-semibold text-sm shadow-md`}
                      >
                        {testimonial.avatar}
                      </div>
                      <div>
                        <div className="font-semibold text-sm">{testimonial.name}</div>
                        <div className="text-xs text-default-400">{testimonial.business}</div>
                        <div className="text-xs text-default-300">{testimonial.location}</div>
                      </div>
                    </div>
                  </Card>
                ))}
