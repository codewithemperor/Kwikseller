...
import { Shield, Truck, Headphones, RotateCcw, Lock, CreditCard, Smartphone, Building } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-3">
            Why Choose{' '}
            <span className="kwik-gradient-text">KWIKSELLER</span>?
          </h2>
          <p className="text-default-500 max-w-2xl mx-auto text-sm md:text-base">
            We&apos;re committed to making your shopping experience safe, fast, and enjoyable
            across Africa.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <div className="h-px w-full max-w-xl mx-auto bg-gradient-to-r from-transparent via-accent/40 to-transparent" />
        </motion.div>
          ...
          >
            {paymentBadges.map((badge) => (
              <motion.div key={badge.label} variants={itemVariants}>
                <Chip
                  variant="flat"
                  startContent={<badge.icon className="w-3.5 h-3.5" />}
