...
const tiers: RewardTier[] = [
  {
    ...
    description: 'Begin your rewards journey. Every sale earns you coins to unlock better perks.',
    icon: Coins,
  ...
  },
  {
    ...
    description: 'Scale your business with enhanced tools and priority access to support.',
    icon: Star,
  ...
  },
  {
    ...
    subtitle: 'Top Seller',
    description: 'Unlock premium features and get your products featured on the marketplace.',
    icon: Trophy,
  ...
  },
  {
    ...
    description: 'The ultimate seller tier with maximum visibility and dedicated account management.',
    icon: Crown,
      ...
      <Card className="relative overflow-hidden p-5 md:p-6 h-full border-none shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-background">
        ...
        <div className="space-y-1.5">
          ...
          <div className="w-full h-2 rounded-full bg-default-100 dark:bg-default-200/30 overflow-hidden">
            <motion.div
              initial={{ width: 0 }}
              animate={isInView ? { width: `${tier.progressPercent}%` } : { width: 0 }}
...
export function KwikCoinsRewards() {
  ...
  const isMethodsInView = useInView(methodsRef, { once: true, margin: '-40px' })
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Earn While You{' '}
            <span className="kwik-gradient-text">Sell</span>
          </h2>
          <p className="text-default-500 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Our loyalty rewards program lets you earn KwikCoins on every sale. Unlock exclusive
            perks, discounts, and premium features as you climb through the tiers.
          </p>
        </motion.div>
        ...
        <motion.div
          ref={methodsRef}
          initial={{ opacity: 0, y: 30 }}
          animate={isMethodsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
          transition={{ duration: 0.6, ease: 'easeOut' }}
          className="mb-12 md:mb-16"
        >
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="h-px flex-1 max-w-[120px] bg-gradient-to-r from-transparent to-default-200 dark:to-default-700" />
            ...
            <div className="h-px flex-1 max-w-[120px] bg-gradient-to-l from-transparent to-default-200 dark:to-default-700" />
          </div>
        ...
        >
          ...
          <p className="text-default-500 text-sm md:text-base max-w-md mx-auto mb-8">
            Join thousands of vendors already earning rewards on every sale. The more you sell,
            the more you earn.
          </p>
          <Button
            size="lg"
