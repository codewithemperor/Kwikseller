      ...
      <Card className="group p-6 h-full cursor-pointer hover:shadow-lg transition-all duration-300 hover:scale-[1.02] border border-transparent hover:border-accent/20">
        <div className="flex items-start gap-4 mb-4">
          <div className="relative">
            <div
              className={`w-14 h-14 rounded-full bg-accent flex items-center justify-center text-white font-bold text-lg shadow-md`}
            >
              {vendor.avatar}
            </div>
            {vendor.isVerified && (
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <Chip size="sm" variant="soft" className="text-[10px] shrink-0">
                {vendor.badge}
              </Chip>
            </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-default-500 max-w-2xl mx-auto">
              Meet our highest-rated sellers delivering exceptional products and
