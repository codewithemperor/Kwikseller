...
import { AppButton, AppModal, FieldInput, FieldSelect, FieldTextarea } from "@kwikseller/ui";
        ...
        <form onSubmit={createProduct} className="space-y-4">
          ...
          {form.productType === "PHYSICAL" && (
            <div className="grid grid-cols-2 gap-3">
              ...
              <AppButton fullWidth size="lg" isLoading={isSaving} loadingLabel="Saving product...">
                <Plus className="h-4 w-4" />
                Create product
              </AppButton>
        </form>
