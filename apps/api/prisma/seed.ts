...
const VENDOR_MILESTONES = [
  ...
  },
  {
    key: "store_verified",
    name: "Store Verified",
    description: "Get your store verified",
    coinsAwarded: 200,
    isRepeatable: false,
  },
  {
    key: "monthly_referral",
    name: "Monthly Referral Bonus",
    description: "Refer a new vendor each month",
    coinsAwarded: 50,
    isRepeatable: true,
  },
];
