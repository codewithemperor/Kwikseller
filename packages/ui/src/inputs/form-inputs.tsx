...
const formInputGroupClass =
  "min-h-16 rounded-2xl border border-border bg-field-background text-base shadow-sm outline-none ring-0 transition focus-within:border-border focus-within:outline-none focus-within:ring-0 focus-within:ring-transparent data-[focus-visible=true]:outline-none data-[focus-visible=true]:ring-0 dark:border-white/10 dark:bg-[#07111f]";
const formInputClass = "h-16 text-base text-foreground outline-none ring-0 placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 dark:text-white";
