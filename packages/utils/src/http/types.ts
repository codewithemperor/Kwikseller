/**
 * HTTP type definitions (re-aligned to @kwikseller/api-client).
 * Kept for backward compatibility with code that imported types from
 * `@kwikseller/utils`'s http module.
 */
import type { AxiosRequestConfig } from "axios";
import type { ApiResponse, PaginatedResponse } from "@kwikseller/api-client";
